...
<a href="cadastro-bateria.php">[Cadastrar Bateria]</a> <a href="novo-formulario.php">[Novo Formulario]</a> <a href="bateria-reserva.php">[Bateria Reserva]</a> <a href=""></a> <a href="relatorios.php">[Relatórios]</a>  <a href="logout.php">[Sair]</a>
...
<?php foreach($formulario as $form):  if( $form['status']  == 'em aberto'): ?>
